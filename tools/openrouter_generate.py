...
def _call_openrouter(api_key: str, model: str, prompt: str, max_tokens: int, temperature: float) -> str:
...
def main() -> None:
    ...
    for case in cases:
        ...
        for attempt in range(args.retries + 1):
            raw = _call_openrouter(api_key, args.model, prompt, args.max_tokens, args.temperature)
            try:
